...
export const EyeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639l4.43-4.43a1.012 1.012 0 0 1 1.416 0l4.43 4.43a1.012 1.012 0 0 1 0 .639l-4.43 4.43a1.012 1.012 0 0 1-1.416 0l-4.43-4.43Z" />
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-2.253a9.527 9.527 0 0 0-1.789-1.556A9.613 9.613 0 0 0 18 13.018c0-2.786.595-5.433 1.58-7.778M15 19.128v-2.828c0-.853.083-1.685.25-2.488m-.25 5.316c-.62.374-1.29.643-2 .823m-2-8.23a9.527 9.527 0 0 1-1.789-1.556A9.613 9.613 0 0 1 6 13.018c0-2.786.595-5.433 1.58-7.778m0 0A9.337 9.337 0 0 1 12 2.253a9.337 9.337 0 0 1 4.121 2.253m-8.242 0c.261.21.503.445.728.704a9.613 9.613 0 0 1 2.418 5.334M3 21a9 9 0 0 1 9-9c1.646 0 3.18.506 4.498 1.342" />
    </svg>
);
...
export const ChatBubbleBottomCenterTextIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.761 9.761 0 0 1-2.542-.384m-2.274-1.152a3.375 3.375 0 0 0-3.374-3.374M21 12a9 9 0 0 0-9-9c-4.556 0-8.25 4.03-8.25 9m17.616-4.47-1.428-1.428a1.5 1.5 0 0 0-2.12 0l-1.428 1.428m1.428 1.428 1.428 1.428m-1.428-1.428-1.428-1.428" />
  </svg>
);
